...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        String accessToken = tokenProvider.getTokenFromHeader(request, "Access");
        String refreshToken = tokenProvider.getTokenFromHeader(request, "Refresh");
        ...
        if(accessToken != null) {
            ...
            setAuthentication(tokenProvider.getUserIdFromToken(refreshToken));
        }
